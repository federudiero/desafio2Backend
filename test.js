...
async function main(){
    ...
    // Prueba metodo save()
    let newProduct1 = {"id":15, "name":"fultbol", "price": 1800, "src":"/resources/img/product-images/futbol.jpg"} // Prueba con un producto que ya posee id
    await products.save(newProduct1)
    let newProduct2 = {"name":"rugby", "price": 800, "src":"/resources/img/product-images/rugby.jpg"} // Prueba con un producto sin id
